...
public class ChatPopUp2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_pop_up2);
        mAuth = FirebaseAuth.getInstance();
        mUsers = FirebaseDatabase.getInstance().getReference().child("Users");
        currentUser = mAuth.getCurrentUser();


        txtclose = findViewById(R.id.txtclose2);
        sec_answer =findViewById(R.id.confirm_sec_answer1);
        txtclose.setText("X");

        submit = findViewById(R.id.btn_submit_answer1);
                        ...
                        mUsers.child(mAuth.getUid().toString()).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (onlineAns.equalsIgnoreCase(subAns)){
                                    Intent toDocHistory = new Intent(ChatPopUp2.this, BotHistory.class);
                                    ...
                                    MDToast.makeText(ChatPopUp2.this,"Incorrect security answer, pls try again",
